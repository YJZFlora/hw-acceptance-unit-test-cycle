...
describe Movie do
    ...
    describe '.find_same_director' do
        it 'when find movies by same director' do
            expect(Movie.find_same_director(movie1.director)).to eql([movie1, movie4])
        end

        it 'when find movies by different director' do
            expect(Movie.find_same_director(movie1.director)).to_not include([movie2, movie3])
        end

        it 'when find movies without director info' do
            expect(Movie.find_same_director(movie3.director)).to eql(nil)
        end
    end
